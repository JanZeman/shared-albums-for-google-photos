...
$pages = array(
	...
	'viewer-fixture'    => array(
		...
		'content' => implode(
			"\n\n",
			array(
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-max-width="600" viewer-max-height="400"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-max-width="600" viewer-max-height="400" fullscreen-max-width="1200" fullscreen-max-height="800"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-image-fit="cover"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" fullscreen-image-fit="cover"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" image-fit="contain" background-color="rgba(128,0,64,0.7)" viewer="lightbox, fullscreen" lightbox-corner-radius="16" viewer-max-width="600" viewer-max-height="400" viewer-background-color="rgba(128,0,64,0.7)" lightbox-backdrop-color="rgba(0,128,64,0.7)"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-controls-color="#E63946" lightbox-controls-color="#00A878"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="fullscreen" fullscreen-slideshow="auto"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-slideshow="auto" lightbox-slideshow-delay="1" fullscreen-slideshow-delay="7-9"]',
			)
		),
	),
	'random-fixture'    => array(
		...
		'content' => implode(
			"\n\n",
			array(
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer-toggle="double-click"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="fullscreen"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="fullscreen" viewer-toggle="double-click"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer-toggle="double-click" lightbox-fullscreen="button"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-mosaic="true" viewer-mosaic-count="4" viewer-mosaic-position="left" viewer-mosaic-layout="overlay" viewer-mosaic-gap="4"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-max-width="700" viewer-max-height="420" lightbox-max-width="500" fullscreen-max-width="1100" viewer-image-fit="cover" fullscreen-image-fit="contain" lightbox-controls-color="#00A878" fullscreen-controls-color="#2A9D8F"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-background-color="rgba(128,0,64,0.7)" lightbox-backdrop-color="rgba(0,128,64,0.7)" viewer-controls-color="#E63946" lightbox-controls-color="#00A878" fullscreen-controls-color="#2A9D8F"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-slideshow="auto" lightbox-slideshow-delay="2-4" fullscreen-slideshow-delay="9"]',
				'[jzsa-album link="' . $album_link . '" mode="slider" width="600" corner-radius="16" viewer="lightbox, fullscreen" viewer-show-navigation="false" viewer-info-top="Wild {item}" viewer-info-bottom="{item} / {items}" viewer-corner-radius="24" lightbox-corner-radius="8" fullscreen-corner-radius="0"]',
			)
		),
	),
