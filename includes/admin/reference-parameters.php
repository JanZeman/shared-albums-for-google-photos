					...
					<p><?php echo wp_kses_post( __( 'For a concrete example, see Guide sample 36: Lightbox + Fullscreen - Shared Display Settings via One Param. It sets <code>fullscreen-controls-color="#E63946"</code> but no <code>lightbox-controls-color</code>, so both expanded views use red controls. Add <code>lightbox-controls-color="green"</code> and the lightbox controls become green while fullscreen stays red.', 'janzeman-shared-albums-for-google-photos' ) ); ?></p>
					<table class="jzsa-settings-table jzsa-settings-table--params">
						<thead>
							<tr>
								<th>Parameter</th>
