					...
					<p><?php echo wp_kses_post( __( 'Use <code>lightbox-*</code> parameters when you want to change only the Lightbox side of the shared viewer behavior. For example, <code>lightbox-controls-color</code> changes Lightbox controls without changing Fullscreen controls.', 'janzeman-shared-albums-for-google-photos' ) ); ?></p>
					<table class="jzsa-settings-table jzsa-settings-table--params">
						<thead>
							<tr>
								<th>Parameter</th>
