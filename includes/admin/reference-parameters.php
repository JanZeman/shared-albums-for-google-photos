					...
					<table class="jzsa-settings-table jzsa-settings-table--params">
						...
						<h4><?php esc_html_e( 'Viewer Examples', 'janzeman-shared-albums-for-google-photos' ); ?></h4>
						<p><code><?php echo esc_html( 'viewer="lightbox" viewer-trigger="double-click"' ); ?></code></p>
						<p><code><?php echo esc_html( 'viewer="both" lightbox-trigger="double-click" fullscreen-trigger="button"' ); ?></code></p>
					<table class="jzsa-settings-table jzsa-settings-table--params">
						<thead>
							<tr>
								<th><?php esc_html_e( 'Parameter', 'janzeman-shared-albums-for-google-photos' ); ?></th>
