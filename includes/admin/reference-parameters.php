					...
					<table class="jzsa-settings-table jzsa-settings-table--params">
						...
						<tbody>
							...
							<tr><td><code>info-wrap</code></td><td><?php esc_html_e( 'Allow info box text to wrap to multiple lines instead of being cut off with "...". Applies to info-top, info-top-secondary, info-bottom, gallery-info-bottom, and their fullscreen variants. Useful when displaying long values such as descriptions ({description}) or combined EXIF strings. Set to "true" to enable wrapping; by default text is kept to a single line.', 'janzeman-shared-albums-for-google-photos' ); ?></td><td><em><?php esc_html_e( 'false (single line)', 'janzeman-shared-albums-for-google-photos' ); ?></em></td></tr>
